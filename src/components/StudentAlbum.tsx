...
export default function StudentAlbum() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const storedName = localStorage.getItem("mobilart_student_name") || "";
      setStudentName(storedName);
      
      const storedPoints = Number(localStorage.getItem("mobilart_artipuntos") || "0");
      setPoints(storedPoints);

      setBadges({
        trivia: localStorage.getItem("mobilart_completed_trivia") === "true",
        colormix: localStorage.getItem("mobilart_completed_colormix") === "true",
        puzzle: localStorage.getItem("mobilart_completed_puzzle") === "true",
        matching: localStorage.getItem("mobilart_completed_matching") === "true",
        rhythm: localStorage.getItem("mobilart_completed_rhythm") === "true",
        roulette: localStorage.getItem("mobilart_completed_roulette") === "true",
      });
    }
  }, [isOpen]);
